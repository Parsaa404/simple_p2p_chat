...
class DHExchange:
    ...
    def generate_parameters_and_keys(self):
        ...
        self.public_key_bytes = self.private_key.public_key().public_bytes(
            encoding=serialization.Encoding.PEM, # Changed dh.serialization to serialization
            format=serialization.PublicFormat.SubjectPublicKeyInfo # Changed dh.serialization to serialization
        )
    ...
    def generate_keys_with_parameters(self, peer_parameters_bytes: bytes):
        ...
        """
        try:
            self.parameters = serialization.load_pem_parameters(peer_parameters_bytes, default_backend()) # Changed dh.serialization to serialization
            self.private_key = self.parameters.generate_private_key()
            self.public_key_bytes = self.private_key.public_key().public_bytes(
                encoding=serialization.Encoding.PEM, # Changed dh.serialization to serialization
                format=serialization.PublicFormat.SubjectPublicKeyInfo # Changed dh.serialization to serialization
    ...
    def calculate_shared_secret(self, peer_public_key_bytes: bytes):
        ...
        try:
            peer_public_key = serialization.load_pem_public_key(peer_public_key_bytes, default_backend()) # Changed dh.serialization to serialization
        except Exception as e:
    ...
    def get_parameters_bytes(self):
        ...
        return self.parameters.parameter_bytes(
            encoding=serialization.Encoding.PEM, # Changed dh.serialization to serialization
            format=serialization.ParameterFormat.PKCS3 # Changed dh.serialization to serialization
        )
